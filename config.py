...
SEG_MIN_POLYGON_AREA = 20.0

# mask rasterize + contour pipeline (替代 Shapely exterior)
SEG_USE_MASK_CONTOUR = True
SEG_MASK_SUPERSAMPLE = 1

SEG_KEEP_LARGEST_COMPONENT = True
SEG_MIN_COMPONENT_AREA = 20
SEG_MIN_COMPONENT_AREA_RATIO = 0.03

SEG_FILL_HOLES = True
SEG_CONTOUR_APPROX_EPSILON = 1.0
